function BusinessPurposeTableView({
  rows,
  filters,
  setFilters,
  onAdd,
              ...
              return (
                <tr key={`${r.name || idx}`}>
                  ...
                  <td>
                    ...
                    <button className="iconBtn" title="Remove duplicate" onClick={() => onDedupe(r)}>
                      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M21 12a9 9 0 0 0-9-9" />
                        <path d="M3 12a9 9 0 0 0 9 9" />
                        <polyline points="16 5 12 3 14 7" />
                        <polyline points="8 19 12 21 10 17" />
                      </svg>
                    </button>
