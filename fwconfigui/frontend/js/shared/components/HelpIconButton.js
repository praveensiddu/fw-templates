function HelpIconButton({ docPath, title }) {
  ...
  return (
    <>
      {modalState.isOpen && (
        ...
        >
          ...
          >
            ...
            >
              <h3 style={{ margin: 0, fontSize: "20px", fontWeight: 600, color: "#0d6efd" }}>{modalState.title}</h3>
              <button
                onClick={closeModal}
                style={{
                  border: "none",
            ...
            <div style={{ color: "#212529", lineHeight: 1.5 }}>
              ...
              <div
                ...
                style={{ textTransform: "none", letterSpacing: "normal", fontSize: "14px", fontWeight: "normal" }}
      ...
      <button type="button" onClick={onClick} aria-label="Help" title={title || "Help"} className="iconBtn iconBtn-help">
